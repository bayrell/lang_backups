...
Runtime.Exceptions.AssignStructValueError = function(__ctx, name, context, prev)
{
	...
	use("Runtime.Exceptions.RuntimeException").call(this, __ctx, __v0.translate(__ctx, "Can not set key '" + use("Runtime.rtl").toString(name) + use("Runtime.rtl").toString("' in immutable struct"), null, "", context), __v1.ERROR_INDEX_OUT_OF_RANGE, context, prev);
};

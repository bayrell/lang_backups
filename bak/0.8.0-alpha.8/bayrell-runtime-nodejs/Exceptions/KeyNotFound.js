...
Runtime.Exceptions.KeyNotFound = function(__ctx, key, context, prev)
{
	...
	use("Runtime.Exceptions.RuntimeException").call(this, __ctx, "Key '" + use("Runtime.rtl").toString(key) + use("Runtime.rtl").toString("' not found"), __v0.ERROR_KEY_NOT_FOUND, context, prev);
};

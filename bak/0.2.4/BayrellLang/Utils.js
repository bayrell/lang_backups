...
class Utils extends ContextObject{
	 ...
	 */
	static translateFile(parser_factory_name, translator_factory_name, src_file_name, dest_file_name, context){
		if (context == undefined) context=null;
		var content = fs.fileGetContents(src_file_name);
		var res = Utils.translate(parser_factory_name, translator_factory_name, content, context);

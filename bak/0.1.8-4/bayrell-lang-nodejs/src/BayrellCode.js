...
class BayrellCode{
	...
	/*  список зарезервированных слов в PH */
	/*  Операции */
...
BayrellCode.PHP_RTL_FUNC = ["var_dump", "ord", "trim", "strlen", "str_repeat", "strpos", "strfind", "strtoupper", "substr", "base64_encode", "base64_decode", "json_decode_ex", "json_encode_ex", "explode", "implode", "preg_replace", "preg_match", "time", "microtime", "array_reverse", "array_sort", "array_pop", "array_push", "array_merge", "count", "is_array", "is_string", "is_object", "is_numeric", "gettype", "isset", "in_array", "rand", "mt_rand", "dirname", "file_get_contents", "file_put_contents", "file_exists", "filemtime", "mkdir"];
BayrellCode.TYPES = ["int32", "uint32", "int64", "uint64", "double", "int", "string", "array", "var", "object", "pointer"];
BayrellCode.FLAGS = ["export", "static", "const", "public", "private", "declare", "protected"];

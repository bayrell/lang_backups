...
var TranslatorBay = require('./TranslatorBay.js');
class TranslatorBayFactory extends ContextObject{
	/**
...
TranslatorBayFactory.__static_implements__ = [];
TranslatorBayFactory.__static_implements__.push(FactoryInterface)
module.exports = TranslatorBayFactory;
...
BayrellCode.TOKEN_WORD = "word";
BayrellCode.TOKEN_MULTILINE_COMMENT = "multiline_comment";
BayrellCode.TOKEN_SINGLELINE_COMMENT = "singleline_comment";
BayrellCode.TOKEN_STRING = "string";
BayrellCode.TOKEN_JSON = "json";
BayrellCode._ident = "  ";
BayrellCode._crlf = "\n";
BayrellCode._prev_nope = false;

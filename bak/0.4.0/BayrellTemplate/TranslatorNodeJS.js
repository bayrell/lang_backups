...
class TranslatorNodeJS extends TranslatorES6{
	...
	OpNamespace(op_code){
		...
		if (this.current_module_name != "Runtime"){
			return "var rs = require('BayrellRuntime').rs;"+rtl.toString(this.s("var rtl = require('BayrellRuntime').rtl;"))+rtl.toString(this.s("var Vector = require('BayrellRuntime').Vector;"))+rtl.toString(this.s("var Map = require('BayrellRuntime').Map;"));
		}
		return "";
	}
	/**

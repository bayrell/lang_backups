...
Object.assign(Bayrell.Lang.CoreTranslator.prototype,
{
	...
	assignObject: function(ctx,o)
	{
		if (o instanceof use("Bayrell.Lang.CoreTranslator"))
		{
			...
			this.is_init_function = o.is_init_function;
	...
	assignValue: function(ctx,k,v)
	{
		...
		else if (k == "is_init_function")this.is_init_function = v;
	...
	takeValue: function(ctx,k,d)
	{
		...
		else if (k == "is_init_function")return this.is_init_function;
...
Object.assign(Bayrell.Lang.CoreTranslator,
{
	...
	getFieldInfoByName: function(ctx,field_name)
	{
		...
		if (field_name == "is_init_function") return new IntrospectionInfo(ctx, {
			"kind": IntrospectionInfo.ITEM_FIELD,
			"class_name": "Bayrell.Lang.CoreTranslator",
			"name": field_name,
			"t": "bool",

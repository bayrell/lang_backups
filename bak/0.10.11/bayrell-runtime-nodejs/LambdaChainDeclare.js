...
Runtime.LambdaChainDeclare = function(ctx)
{
	use("Runtime.BaseStruct").apply(this, arguments);
};
Runtime.LambdaChainDeclare.prototype = Object.create(use("Runtime.BaseStruct").prototype);
...
Object.assign(Runtime.LambdaChainDeclare.prototype,
{
	...
	{
		if (o instanceof use("Runtime.LambdaChainDeclare"))
		{
			this.name = o.name;
...
Object.assign(Runtime.LambdaChainDeclare, use("Runtime.BaseStruct"));
Object.assign(Runtime.LambdaChainDeclare,
{
	...
	getClassInfo: function(ctx)
	{
		...
		return new IntrospectionInfo(ctx, {
			...
			"class_name": "Runtime.LambdaChainDeclare",
			"name": "Runtime.LambdaChainDeclare",

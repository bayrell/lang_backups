...
Runtime.Driver = function(ctx)
{
	use("Runtime.Entity").apply(this, arguments);
};
Runtime.Driver.prototype = Object.create(use("Runtime.Entity").prototype);
...
Object.assign(Runtime.Driver.prototype,
{
	...
	{
		return this.getClassName(ctx) + use("Runtime.rtl").toStr(" -> ") + use("Runtime.rtl").toStr(this.name) + use("Runtime.rtl").toStr(" -> ") + use("Runtime.rtl").toStr(((this.value != "") ? (this.value) : (this.name)));
	},
	_init: function(ctx)
	{
	...
	{
		if (o instanceof use("Runtime.Driver"))
		{
...
Object.assign(Runtime.Driver, use("Runtime.Entity"));
Object.assign(Runtime.Driver,
{
	...
	getFieldInfoByName: function(ctx,field_name)
	{
		...
		var Dict = use("Runtime.Dict");
		var IntrospectionInfo = use("Runtime.IntrospectionInfo");
		if (field_name == "global") return new IntrospectionInfo(ctx, {

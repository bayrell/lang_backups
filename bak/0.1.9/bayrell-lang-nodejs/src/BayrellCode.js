...
class BayrellCode{
	...
	static op_object(obj){
		return {
			"op":BayrellCode.OP_OBJECT,
			"obj":obj,
		};
	}
	...
	static check_load_names(code_tree){
		if (code_tree["op"] == BayrellCode.OP_LOAD_NAMES) {
			code_tree["op"] = BayrellCode.OP_LOAD_NAMES_CALC;
		}
		return code_tree;
	}
...
BayrellCode.ReservedWords = ["for", "if", "while", "foreach", "class", "dict", "int", "int64", "int32", "float", "bool", "boolean", "func", "def", "function", "void", "export", "ifdef", "define", "use", "as", "import", "from", "async", "await", "call", "module", "namespace", "using", "try", "catch", "declare", "forward", "list", "array", "object", "var", "include", "require", "str", "static", "const", "default"];
BayrellCode.PHP_RTL_FUNC = ["var_dump", "ord", "trim", "strlen", "str_repeat", "strpos", "strfind", "strtoupper", "substr", "base64_encode", "base64_decode", "json_decode_ex", "json_encode_ex", "explode", "implode", "preg_replace", "preg_match", "time", "microtime", "array_reverse", "array_sort", "array_pop", "array_push", "array_merge", "count", "is_array", "is_string", "is_object", "is_numeric", "gettype", "isset", "in_array", "rand", "mt_rand", "dirname", "file_get_contents", "file_put_contents", "file_exists", "filemtime", "mkdir", "strtolower", "key_exists"];

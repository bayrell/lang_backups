...
class rtl{
	...
	static convert(value, type_value, def_value, type_template){
		...
		if (value != null){
			...
			else if ((type_value == "Runtime.Vector" || type_value == "Runtime.Map") && type_template != ""){
	 ...
	 * Returns new element
	 * @param string name
	 * @param Dict<mixed> props
	 * @param Collection<mixed> children
	 * @param UIControl<mixed> control
	 */
	static e(name, props, children, control){
		if (control == undefined) control=null;
		return new UIStruct((new Map()).set("name", name).set("kind", UIStruct.TYPE_ELEMENT).set("props", props).set("children", children).set("control", control));
	}
	/**
	 ...
	 * @param Collection<mixed> children	 
	 */
	static c(name, props, children, control){
		if (control == undefined) control=null;
		return new UIStruct((new Map()).set("name", name).set("kind", UIStruct.TYPE_COMPONENT).set("props", props).set("children", children).set("control", control));
	}
	/**
	 * Translate message

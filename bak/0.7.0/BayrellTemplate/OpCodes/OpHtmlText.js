...
var OpValueString = require('bayrell-lang-nodejs').OpCodes.OpValueString;
...
class OpHtmlText extends OpValueString{
	...
	getClassName(){return "BayrellTemplate.OpCodes.OpHtmlText";}
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "op"){this.op = rtl.correct(value,"string","op_html_text","");this.assignValueAfter("op",value,sender);}

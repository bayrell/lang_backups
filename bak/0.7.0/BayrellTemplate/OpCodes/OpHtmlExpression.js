...
class OpHtmlExpression extends OpChilds{
	 ...
	 */
	getClassName(){
		return "BayrellTemplate.OpCodes.OpHtmlExpression";
	}
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "op"){this.op = rtl.correct(value,"string","op_html_expression","");this.assignValueAfter("op",value,sender);}
...
module.exports = OpHtmlExpression;
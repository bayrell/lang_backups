...
class OpHtmlCall extends OpCall{
	 ...
	 */
	getClassName(){
		return "BayrellTemplate.OpCodes.OpHtmlCall";
	}
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "op"){this.op = rtl.correct(value,"string","op_html_call","");this.assignValueAfter("op",value,sender);}

...
Runtime.Exceptions.IndexOutOfRange = function(ctx, context, prev)
{
	var __v0 = use("Runtime.rtl");
	var __v1 = use("Runtime.RuntimeConstant");
	use("Runtime.Exceptions.RuntimeException").call(this, ctx, __v0.translate(ctx, "Index out of range", null, "", context), __v1.ERROR_INDEX_OUT_OF_RANGE, context, prev);
};

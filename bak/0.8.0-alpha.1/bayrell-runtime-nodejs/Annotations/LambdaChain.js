...
Runtime.Annotations.LambdaChain = function()
{
...
Object.assign(Runtime.Annotations.LambdaChain.prototype,
{
	_init: function()
	{
		...
		this.__chain = "";
		if (a.indexOf("chain") == -1)Object.defineProperty(this, "chain",{get:function(){return this.__chain;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("chain");}});
		this.__pos = 0;
		if (a.indexOf("pos") == -1)Object.defineProperty(this, "pos",{get:function(){return this.__pos;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("pos");}});

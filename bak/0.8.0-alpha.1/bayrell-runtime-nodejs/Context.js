...
Object.assign(Runtime.Context.prototype,
{
	...
	_init: function()
	{
		...
		if (a.indexOf("base_path") == -1)Object.defineProperty(this, "base_path",{get:function(){return this.__base_path;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("base_path");}});
		this.__env = null;
		if (a.indexOf("env") == -1)Object.defineProperty(this, "env",{get:function(){return this.__env;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("env");}});
		this.__settings = null;
		if (a.indexOf("settings") == -1)Object.defineProperty(this, "settings",{get:function(){return this.__settings;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("settings");}});
		this.__modules = null;
		...
		if (a.indexOf("entities") == -1)Object.defineProperty(this, "entities",{get:function(){return this.__entities;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("entities");}});
		this.__drivers = null;
		if (a.indexOf("drivers") == -1)Object.defineProperty(this, "drivers",{get:function(){return this.__drivers;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("drivers");}});
		this.__providers = null;
		if (a.indexOf("providers") == -1)Object.defineProperty(this, "providers",{get:function(){return this.__providers;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("providers");}});
		this.__tags = null;
		if (a.indexOf("tags") == -1)Object.defineProperty(this, "tags",{get:function(){return this.__tags;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("tags");}});
		this.__initialized = false;
		if (a.indexOf("initialized") == -1)Object.defineProperty(this, "initialized",{get:function(){return this.__initialized;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("initialized");}});
		this.__started = false;
		if (a.indexOf("started") == -1)Object.defineProperty(this, "started",{get:function(){return this.__started;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("started");}});
...
Object.assign(Runtime.Context,
{
	...
	create: function(env)
	{
		...
		/* Get module and settings */
		var m = this.getModules(env);
		var modules = (m != null) ? m.keys() : use("Runtime.Collection").create([]);
		var settings = this.getSettings(env);
		/* Extends modules */
		...
		/* Base path */
		var base_path = _v0.attr(settings, use("Runtime.Collection").create(["base_path"]), "", "string");
		if (base_path == "")
		{
			base_path = _v0.attr(env, use("Runtime.Collection").create(["BASE_PATH"]), "", "string");
		}
		/* Context data */
	...
	_getRequiredModules: function(res,cache,modules,filter)
	{
		...
		for (var i = 0;i < modules.count();i++)
		{
			...
			if (cache.get(module_name, false) == false)
			{
				...
				var requiredModules = _v0.method(module_name + use("Runtime.rtl").toString(".ModuleDescription"), "requiredModules");
	...
	{
		var _v0 = use("Runtime.RuntimeUtils");
		var _v1 = use("Runtime.Annotations.Entity");
		...
		for (var i = 0;i < entities.count();i++)
		{
			...
			if (item1_class_name == "Runtime.Annotations.Entity")
			{
				...
				var info = _v0.getClassIntrospection(class_name);
				for (var j = 0;j < info.info.count();j++)
				{
					var item2 = info.info.item(j);
					var item2_class_name = item2.getClassName();
					if (item2 instanceof _v1 && item2_class_name != "Runtime.Annotations.Entity")
					{
	...
	start: function(context)
	{
		...
		var i;
		var drivers = context.drivers.keys();
		for (i = 0;i < drivers.count();i++)
		{
			var driver_name = drivers.item(i);
			var driver = context.drivers.item(driver_name);
			driver.startDriver();
		}
		return context.copy(use("Runtime.Dict").create({"started":true}));
	},
	/**
	...
	getProvidersFromEntities: function(context)
	{
		...
		var arr = context.entities.filter((item) => 
		{
			...
			return item instanceof _v0;
		});
		var providers = new _v0();
	...
	getDriversFromEntities: function(context)
	{
		...
		var arr = context.entities.filter((item) => 
		{
			var _v0 = use("Runtime.Annotations.Driver");
			return item instanceof _v0;
		});
		var drivers = new _v0();
		for (var i = 0;i < arr.count();i++)
		{
			...
			var driver = _v1.newInstance(class_name, use("Runtime.Collection").create([context]));
	...
	{
		var _v0 = use("Runtime.Exceptions.RuntimeException");
		var _v1 = use("Runtime.rtl");
		if (params == undefined) params = null;
		if (params == null)
		{
		...
		if (context.providers.has(provider_name))
		{
			...
			{
				throw new _v0("Provider " + use("Runtime.rtl").toString(provider_name) + use("Runtime.rtl").toString(" does not declared"));
			}
			...
			provider = _v1.newInstance(class_name, use("Runtime.Collection").create([params]));
		...
		{
			throw new _v0("Provider " + use("Runtime.rtl").toString(provider_name) + use("Runtime.rtl").toString(" not found"));
		}
		return provider;
	},
	/**
	...
	getProvider: function(context,provider_name,settings_name)
	{
		...
		var params = _v0.attr(context.settings, use("Runtime.Collection").create(["providers",provider_name,settings_name]));
	...
	chain: function(context,chain_name,args)
	{
		...
		{
			var _v0 = use("Runtime.Annotations.LambdaChain");
			return item instanceof _v0 && item.name == chain_name && item.is_async == false;
		});
		...
		for (var i = 0;i < entities.count();i++)
		{
			...
			{
				var arr = _v0.split("::", item.value);
				var class_name = arr.get(0, "");
				var method_name = arr.get(1, "");
				var f = _v1.method(class_name, method_name);
				var res = _v1.apply(f, args);
				args = args.setIm(args.count() - 1, res);
			}
		}
		var res = args.last();
	...
	chainAwait: function(context,chain_name,args)
	{
		...
		{
			var _v0 = use("Runtime.Annotations.LambdaChain");
			return item instanceof _v0 && item.name == chain_name;
		});
		entities = entities.sortIm((a,b) => 
		{
			return a.pos > b.pos;
		...
		for (var i = 0;i < entities.count();i++)
		{
			...
			if (item_chain_name != "")
			{
				var res = this.chainAwait(context, item_chain_name, args);
				args = args.setIm(args.count() - 1, res);
			}
			else
			{

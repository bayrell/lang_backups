...
Object.assign(Runtime.Message.prototype,
{
	_init: function()
	{
		...
		if (a.indexOf("is_external") == -1)Object.defineProperty(this, "is_external",{get:function(){return this.__is_external;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("is_external");}});
		this.__session = null;
		if (a.indexOf("session") == -1)Object.defineProperty(this, "session",{get:function(){return this.__session;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("session");}});

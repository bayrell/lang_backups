...
Object.assign(Runtime.BusResult.prototype,
{
	_init: function()
	{
		...
		if (a.indexOf("success") == -1)Object.defineProperty(this, "success",{get:function(){return this.__success;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("success");}});
		this.__code = 0;
		...
		this.__url = "";
		if (a.indexOf("url") == -1)Object.defineProperty(this, "url",{get:function(){return this.__url;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("url");}});
		this.__api_name = "";
		if (a.indexOf("api_name") == -1)Object.defineProperty(this, "api_name",{get:function(){return this.__api_name;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("api_name");}});
		this.__interface_name = "";
		if (a.indexOf("interface_name") == -1)Object.defineProperty(this, "interface_name",{get:function(){return this.__interface_name;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("interface_name");}});
		this.__method_name = "";
		if (a.indexOf("method_name") == -1)Object.defineProperty(this, "method_name",{get:function(){return this.__method_name;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("method_name");}});
		this.__text = "";
		if (a.indexOf("text") == -1)Object.defineProperty(this, "text",{get:function(){return this.__text;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("text");}});
		this.__data = null;
		if (a.indexOf("data") == -1)Object.defineProperty(this, "data",{get:function(){return this.__data;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("data");}});
		this.__params = null;
		if (a.indexOf("params") == -1)Object.defineProperty(this, "params",{get:function(){return this.__params;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("params");}});
		this.__logs = null;
...
Object.assign(Runtime.BusResult,
{
	 ...
	 * @return bool
	 */
	isSuccess: function(bus)
	{
		var _v0 = use("Runtime.RuntimeConstant");
		return bus.success && bus.code >= _v0.ERROR_OK;
	},
	/**
	 * Set error data
	 * @param int code
	 ...
	 * @return BusResult
	 */
	setError: function(bus,error,code)
	{
		if (error == undefined) error = "";
		return bus.copy(use("Runtime.Dict").create({"code":code,"error":error,"success":false}));
	},
	/**
	 * Set result
	 * @param primitive res
	 * @return BusResult
	 */
	setSuccess: function(bus,res)
	{
		var _v0 = use("Runtime.RuntimeConstant");
		return bus.copy(use("Runtime.Dict").create({"code":_v0.ERROR_OK,"error":"","success":true,"data":res}));
	},
	/**
	 * Set result
	 * @param primitive res
	 * @return BusResult
	 */
	setResult: function(bus,res)
	{
		return bus.copy(res.takeDict());
	},
	/**
	 * Set result
	 * @param primitive res
	...
	create: function(res)
	{
		var _v0 = use("Runtime.BusResult");
		var _v1 = use("Runtime.RuntimeConstant");
		return new _v0(use("Runtime.Dict").create({"code":_v1.ERROR_OK,"error":"","success":true,"data":res}));
	},
	/**
	 * Set result
	 * @param primitive res
	...
	fail: function(res,error,code)
	{
		...
		return new _v0(use("Runtime.Dict").create({"code":code,"error":error,"success":false,"data":res}));
	},

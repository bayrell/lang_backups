...
Object.assign(Bayrell.Lang.OpCodes.OpAssign.prototype,
{
	_init: function()
	{
		...
		this.__names = null;
		if (a.indexOf("names") == -1)Object.defineProperty(this, "names",{get:function(){return this.__names;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("names");}});

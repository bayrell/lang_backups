...
Object.assign(Bayrell.Lang.OpCodes.OpTypeIdentifier.prototype,
{
	_init: function()
	{
		...
		this.__entity_name = "";
		if (a.indexOf("entity_name") == -1)Object.defineProperty(this, "entity_name",{get:function(){return this.__entity_name;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("entity_name");}});

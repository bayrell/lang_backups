...
Object.assign(Bayrell.Lang.OpCodes.OpUse.prototype,
{
	_init: function()
	{
		...
		this.__alias = "";
		if (a.indexOf("alias") == -1)Object.defineProperty(this, "alias",{get:function(){return this.__alias;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("alias");}});
		this.__name = "";

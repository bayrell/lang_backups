...
Object.assign(Bayrell.Lang.OpCodes.OpMath.prototype,
{
	_init: function()
	{
		...
		this.__math = "";
		if (a.indexOf("math") == -1)Object.defineProperty(this, "math",{get:function(){return this.__math;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("math");}});

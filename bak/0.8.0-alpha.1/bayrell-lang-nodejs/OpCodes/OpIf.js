...
Object.assign(Bayrell.Lang.OpCodes.OpIf.prototype,
{
	_init: function()
	{
		...
		if (a.indexOf("if_false") == -1)Object.defineProperty(this, "if_false",{get:function(){return this.__if_false;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("if_false");}});
		this.__if_else = null;
		if (a.indexOf("if_else") == -1)Object.defineProperty(this, "if_else",{get:function(){return this.__if_else;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("if_else");}});

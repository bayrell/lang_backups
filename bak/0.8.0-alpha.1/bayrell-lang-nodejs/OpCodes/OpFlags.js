...
Object.assign(Bayrell.Lang.OpCodes.OpFlags.prototype,
{
	...
	isFlag: function(name)
	{
		...
		return this.takeValue("p_" + use("Runtime.rtl").toString(name));
	},
	_init: function()
	{
		var a = Object.getOwnPropertyNames(this);
		this.__p_async = false;
		if (a.indexOf("p_async") == -1)Object.defineProperty(this, "p_async",{get:function(){return this.__p_async;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_async");}});
		this.__p_export = false;
		if (a.indexOf("p_export") == -1)Object.defineProperty(this, "p_export",{get:function(){return this.__p_export;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_export");}});
		this.__p_static = false;
		if (a.indexOf("p_static") == -1)Object.defineProperty(this, "p_static",{get:function(){return this.__p_static;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_static");}});
		this.__p_const = false;
		if (a.indexOf("p_const") == -1)Object.defineProperty(this, "p_const",{get:function(){return this.__p_const;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_const");}});
		this.__p_public = false;
		if (a.indexOf("p_public") == -1)Object.defineProperty(this, "p_public",{get:function(){return this.__p_public;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_public");}});
		this.__p_private = false;
		if (a.indexOf("p_private") == -1)Object.defineProperty(this, "p_private",{get:function(){return this.__p_private;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_private");}});
		this.__p_protected = false;
		if (a.indexOf("p_protected") == -1)Object.defineProperty(this, "p_protected",{get:function(){return this.__p_protected;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_protected");}});
		this.__p_declare = false;
		if (a.indexOf("p_declare") == -1)Object.defineProperty(this, "p_declare",{get:function(){return this.__p_declare;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_declare");}});
		this.__p_serializable = false;
		if (a.indexOf("p_serializable") == -1)Object.defineProperty(this, "p_serializable",{get:function(){return this.__p_serializable;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_serializable");}});
		this.__p_cloneable = false;
		if (a.indexOf("p_cloneable") == -1)Object.defineProperty(this, "p_cloneable",{get:function(){return this.__p_cloneable;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_cloneable");}});
		this.__p_assignable = false;
		if (a.indexOf("p_assignable") == -1)Object.defineProperty(this, "p_assignable",{get:function(){return this.__p_assignable;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_assignable");}});
		this.__p_memorize = false;
		if (a.indexOf("p_memorize") == -1)Object.defineProperty(this, "p_memorize",{get:function(){return this.__p_memorize;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_memorize");}});
		this.__p_lambda = false;
		if (a.indexOf("p_lambda") == -1)Object.defineProperty(this, "p_lambda",{get:function(){return this.__p_lambda;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("p_lambda");}});
...
Object.assign(Bayrell.Lang.OpCodes.OpFlags,
{
	...
	getFlags: function()
	{
		return use("Runtime.Collection").create(["async","export","static","const","public","private","declare","protected","serializable","cloneable","assignable","memorize","lambda"]);
	},
	/**
	 * Get flags
	 */

...
Object.assign(Bayrell.Lang.OpCodes.OpTryCatch.prototype,
{
	_init: function()
	{
		...
		this.__op_try = null;
		if (a.indexOf("op_try") == -1)Object.defineProperty(this, "op_try",{get:function(){return this.__op_try;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("op_try");}});
		this.__items = null;

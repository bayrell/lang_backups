...
Object.assign(Bayrell.Lang.SaveOpCode.prototype,
{
	_init: function()
	{
		...
		this.__var_name = "";
		if (a.indexOf("var_name") == -1)Object.defineProperty(this, "var_name",{get:function(){return this.__var_name;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("var_name");}});
		this.__var_content = "";
		if (a.indexOf("var_content") == -1)Object.defineProperty(this, "var_content",{get:function(){return this.__var_content;},set:function(value){throw new Runtime.Exceptions.AssignStructValueError("var_content");}});
		this.__content = "";

...
class OpVector extends BaseOpCode{
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "op"){this.op = rtl.correct(value,"string","op_vector","");this.assignValueAfter("op",value,sender);}
		else if (variable_name == "values"){this.values = rtl.correct(value,"Vector",null,"BayrellLang.OpCodes.BaseOpCode");this.assignValueAfter("values",value,sender);}

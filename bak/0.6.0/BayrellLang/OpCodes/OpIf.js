...
class OpIf extends BaseOpCode{
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "op"){this.op = rtl.correct(value,"string","op_if","");this.assignValueAfter("op",value,sender);}
		...
		else if (variable_name == "if_false"){this.if_false = rtl.correct(value,"Vector",null,"BayrellLang.OpCodes.BaseOpCode");this.assignValueAfter("if_false",value,sender);}
		else if (variable_name == "if_else"){this.if_else = rtl.correct(value,"Vector",null,"BayrellLang.OpCodes.OpIfElse");this.assignValueAfter("if_else",value,sender);}

...
class OpHtmlComment extends OpValue1{
	 ...
	 */
	getClassName(){
		return "BayrellTemplate.OpCodes.OpHtmlComment";
	}
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "op"){this.op = rtl.correct(value,"string","op_html_comment","");this.assignValueAfter("op",value,sender);}

...
class OpHtmlTag extends BaseOpCode{
	...
	assignValue(variable_name, value, sender){if(sender==undefined)sender=null;
		if (variable_name == "op"){this.op = rtl.correct(value,"string","op_html_tag","");this.assignValueAfter("op",value,sender);}
		else if (variable_name == "tag_name"){this.tag_name = rtl.correct(value,"string","","");this.assignValueAfter("tag_name",value,sender);}
		else if (variable_name == "attributes"){this.attributes = rtl.correct(value,"Runtime.Vector",null,"BayrellTemplate.OpCodes.OpHtmlAttribute");this.assignValueAfter("attributes",value,sender);}
		else if (variable_name == "spreads"){this.spreads = rtl.correct(value,"Runtime.Vector",null,"mixed");this.assignValueAfter("spreads",value,sender);}
		...
		else if (variable_name == "is_plain"){this.is_plain = rtl.correct(value,"bool",false,"");this.assignValueAfter("is_plain",value,sender);}

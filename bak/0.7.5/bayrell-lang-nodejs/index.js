...
module.exports = {
	...
	'LangBay': {
		'HtmlToken': require("./LangBay/HtmlToken.js"),
		...
		'TranslatorBay': require("./LangBay/TranslatorBay.js"),
		'TranslatorBayFactory': require("./LangBay/TranslatorBayFactory.js"),
	},
	'LangES6': {
	...
	'Parser': {
        'Exceptions': {
			'ParserEOF': require("./Parser/Exceptions/ParserEOF.js"),
			'ParserError': require("./Parser/Exceptions/ParserError.js"),
			'ParserExpected': require("./Parser/Exceptions/ParserExpected.js"),
        },
        'Interfaces': {
			'ParserInterface': require("./Parser/Interfaces/ParserInterface.js"),
        },
        'CoreParser': require("./Parser/CoreParser.js"),
        'ModuleDescription': require("./Parser/ModuleDescription.js"),
        'ParserConstant': require("./Parser/ParserConstant.js"),
        'ParserCursorPos': require("./Parser/ParserCursorPos.js"),
        'ParserReader': require("./Parser/ParserReader.js"),
        'ParserToken': require("./Parser/ParserToken.js"),
        'TokenPair': require("./Parser/TokenPair.js"),		
	},
	'Search': {
		'ModuleDescription': require("./Search/ModuleDescription.js"),
		'ModuleFind': require("./Search/ModuleFind.js"),
		'ModuleInfo': require("./Search/ModuleInfo.js"),
		'ModuleSearchProvider': require("./Search/ModuleSearchProvider.js"),
	},

...
class TranslatorES6 extends CommonTranslator{
	...
	OpStatic(op_code){
		...
		//console.log(op_code_last.value.getClassName());
		...
		else if (op_code_last.value instanceof OpStatic && op_code_last instanceof OpCall){
			return rtl.toString(this.translateRun(op_code.value))+".constructor."+rtl.toString(op_code.name);
		}

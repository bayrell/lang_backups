...
var AssetsInterface = require('./AssetsInterface.js');
class ModuleDescription{
	...
	static getModuleFiles(){
		return (new Vector()).push("Core.Interfaces.ApiDeclaringInterface").push("Core.Interfaces.AssetsInterface").push("Core.Interfaces.ComponentInterface").push("Core.Interfaces.FrontendInterface").push("Core.Interfaces.RoutesDeclaringInterface").push("Core.Interfaces.RoutesInterface").push("Core.Interfaces.ModuleDescription");
	}
	/**
	 * Returns enities
	 */

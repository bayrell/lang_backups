...
class BayrellCode{
	...
	static op_implements(cond, left, right){
		return {
			"op": BayrellCode.OP_IMPLEMENTS,
			"cond": cond,
			"left": left,
			"right": right,
		};
	...
	static op_declare_class(name, extend_name, implements_arr, childs, flags){
		return {
...
BayrellCode.OP_IMPLEMENTS = "implements";

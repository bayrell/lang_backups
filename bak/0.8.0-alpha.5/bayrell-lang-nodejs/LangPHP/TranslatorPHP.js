...
Object.assign(Bayrell.Lang.LangPHP.TranslatorPHP,
{
	...
	reset: function(t)
	{
		...
		var _v2 = use("Bayrell.Lang.LangPHP.TranslatorPHPHtml");
		var _v3 = use("Bayrell.Lang.LangPHP.TranslatorPHPOperator");
		var _v4 = use("Bayrell.Lang.LangPHP.TranslatorPHPProgram");
		var _v5 = use("Runtime.Collection");
		var _v6 = use("Runtime.Collection");
		return t.copy(use("Runtime.Dict").create({"value":"","current_namespace_name":"","modules":new _v0(),"expression":new _v1(),"html":new _v2(),"operator":new _v3(),"program":new _v4(),"save_vars":new _v5(),"save_op_codes":new _v6(),"save_op_code_inc":0,"preprocessor_flags":use("Runtime.Dict").create({"PHP":true})}));
	},
	/**
	...
	outputSaveOpCode: function(t,save_op_code_value)
	{
		...
		for (var i = 0;i < t.save_op_codes.count();i++)
		{
			...
			var s = (save.content == "") ? t.s(save.var_name + use("Runtime.rtl").toString(" = ") + use("Runtime.rtl").toString(save.var_content) + use("Runtime.rtl").toString(";")) : save.content;

...
Object.assign(Bayrell.Lang.CoreParser.prototype,
{
	...
	_init: function()
	{
		...
		this.__tab_size = 4;
		if (a.indexOf("tab_size") == -1) defProp(this, "tab_size");
		this.__file_name = "";
		if (a.indexOf("file_name") == -1) defProp(this, "file_name");
		this.__content = null;
		if (a.indexOf("content") == -1) defProp(this, "content");
		this.__content_sz = 0;
		if (a.indexOf("content_sz") == -1) defProp(this, "content_sz");
		this.__caret = null;
		if (a.indexOf("caret") == -1) defProp(this, "caret");
		this.__find_ident = true;
		if (a.indexOf("find_ident") == -1) defProp(this, "find_ident");
...
Object.assign(Bayrell.Lang.CoreParser,
{
	...
	setContent: function(parser,content)
	{
		...
		return parser.copy(use("Runtime.Dict").create({"content":new _v0(content),"content_sz":_v1.strlen(content)}));
	},
	/**

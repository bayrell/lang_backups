...
class JsonConvertToString extends CoreObject{
	...
	convertToPrimitiveValue(value, level){
		if (value instanceof Vector){
			...
			var res_str = "["+rtl.toString(this._crlf)+rtl.toString(res.join(","+rtl.toString(this._crlf)))+rtl.toString(this._crlf)+rtl.toString(this.out("]", level));
			return res_str;
		}

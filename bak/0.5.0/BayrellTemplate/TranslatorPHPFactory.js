...
class TranslatorPHPFactory extends ContextObject{
	getClassName(){return "BayrellTemplate.TranslatorPHPFactory";}
...
TranslatorPHPFactory.__static_implements__ = [];
TranslatorPHPFactory.__static_implements__.push(FactoryInterface)

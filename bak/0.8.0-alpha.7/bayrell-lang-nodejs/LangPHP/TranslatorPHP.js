...
Object.assign(Bayrell.Lang.LangPHP.TranslatorPHP,
{
	...
	reset: function(t)
	{
		...
		return t.copy(use("Runtime.Dict").create({"value":"","current_namespace_name":"","modules":new __v0(),"expression":new __v1(),"html":new __v2(),"operator":new __v3(),"program":new __v4(),"save_vars":new __v5(),"save_op_codes":new __v6(),"save_op_code_inc":0,"preprocessor_flags":use("Runtime.Dict").create({"PHP":true})}));
	},
	/**

...
Bayrell.Lang.Exceptions.ParserExpected = function(s, caret, file, context, prev)
{
	...
	use("Bayrell.Lang.Exceptions.ParserError").call(this, s + use("Runtime.rtl").toString(" expected"), caret, file, __v0.ERROR_PARSER_EXPECTED, context, prev);
};
...
Object.assign(Bayrell.Lang.Exceptions.ParserExpected.prototype,
{
	assignObject: function(o)
	{
		...
		use("Bayrell.Lang.Exceptions.ParserError").prototype.assignObject.call(this,o);
	},
	assignValue: function(k,v)
	{
		use("Bayrell.Lang.Exceptions.ParserError").prototype.assignValue.call(this,k,v);
	},
	takeValue: function(k,d)
	{
		if (d == undefined) d = null;
		return use("Bayrell.Lang.Exceptions.ParserError").prototype.takeValue.call(this,k,d);
	},

...
Bayrell.Lang.Exceptions.ParserEOF = function(context, prev)
{
	...
	use("Bayrell.Lang.Exceptions.ParserUnknownError").call(this, "ERROR_PARSER_EOF", __v0.ERROR_PARSER_EOF, context, prev);
};
...
Object.assign(Bayrell.Lang.Exceptions.ParserEOF.prototype,
{
	assignObject: function(o)
	{
		...
		use("Bayrell.Lang.Exceptions.ParserUnknownError").prototype.assignObject.call(this,o);
	},
	assignValue: function(k,v)
	{
		use("Bayrell.Lang.Exceptions.ParserUnknownError").prototype.assignValue.call(this,k,v);
	},
	takeValue: function(k,d)
	{
		if (d == undefined) d = null;
		return use("Bayrell.Lang.Exceptions.ParserUnknownError").prototype.takeValue.call(this,k,d);
	},

...
Object.assign(Bayrell.Lang.LangNode.TranslatorNodeExpression.prototype,
{
	assignObject: function(o)
	{
		...
		use("Bayrell.Lang.LangES6.TranslatorES6Expression").prototype.assignObject.call(this,o);
	},
	assignValue: function(k,v)
	{
		use("Bayrell.Lang.LangES6.TranslatorES6Expression").prototype.assignValue.call(this,k,v);
	},
	takeValue: function(k,d)
	{
		if (d == undefined) d = null;
		return use("Bayrell.Lang.LangES6.TranslatorES6Expression").prototype.takeValue.call(this,k,d);
	},
...
Object.assign(Bayrell.Lang.LangNode.TranslatorNodeExpression,
{
	...
	OpCollection: function(t, op_code)
	{
		...
		var __v0 = use("Runtime.rs");
		content = this.useModuleName(t, "Runtime.Collection") + use("Runtime.rtl").toString(".create([") + use("Runtime.rtl").toString(__v0.join(",", values)) + use("Runtime.rtl").toString("])");
	...
	OpDict: function(t, op_code)
	{
		...
		var __v0 = use("Runtime.rs");
		content = this.useModuleName(t, "Runtime.Dict") + use("Runtime.rtl").toString(".create({") + use("Runtime.rtl").toString(__v0.join(",", values)) + use("Runtime.rtl").toString("})");
		return use("Runtime.Collection").create([t,content]);
	},

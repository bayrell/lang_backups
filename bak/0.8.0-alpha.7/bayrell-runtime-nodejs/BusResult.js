...
Object.assign(Runtime.BusResult,
{
	...
	{
		var __v0 = use("Runtime.RuntimeConstant");
		return bus.copy(use("Runtime.Dict").create({"code":__v0.ERROR_OK,"error":"","success":true,"data":res}));
	},
	/**
	 * Set result
	 * @param primitive res
	...
	create: function(res)
	{
		...
		return new __v0(use("Runtime.Dict").create({"code":__v1.ERROR_OK,"error":"","success":true,"data":res}));
	},
	/**
	 * Set result
	 * @param primitive res
	...
	fail: function(res, error, code)
	{
		...
		var __v0 = use("Runtime.BusResult");
		return new __v0(use("Runtime.Dict").create({"code":code,"error":error,"success":false,"data":res}));
	},

...
Object.assign(Runtime.ModuleDescription,
{
	...
	entities: function()
	{
		...
		return use("Runtime.Collection").create([new __v0(use("Runtime.Dict").create({"name":"Runtime.Interfaces.LocalBusInterface","kind":"interface"})),new __v1(use("Runtime.Dict").create({"name":"Runtime.Interfaces.RemoteBusInterface","kind":"interface"})),new __v2(use("Runtime.Dict").create({"name":"Runtime.Entities"}))]);
	},
	/**
	 * Returns enities
	 */

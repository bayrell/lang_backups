...
{
	toString: function(/*__ctx,*/ value){ return use("Runtime.rtl").toString(/*__ctx,*/ value); },
	toObject: function()
	{
		var obj = {};
...
Object.assign(Runtime.Dict.prototype,
{
	...
	assignObject: function(o)
	{
		...
		use("Runtime._Map").prototype.assignObject.call(this,o);
	},
	assignValue: function(k,v)
	{
		use("Runtime._Map").prototype.assignValue.call(this,k,v);
	},
	takeValue: function(k,d)
	{
		if (d == undefined) d = null;
		return use("Runtime._Map").prototype.takeValue.call(this,k,d);
	},

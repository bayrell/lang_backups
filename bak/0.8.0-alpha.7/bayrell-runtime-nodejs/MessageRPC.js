...
Object.assign(Runtime.MessageRPC,
{
	...
	success: function(response)
	{
		...
		return new __v0(use("Runtime.Dict").create({"code":__v1.ERROR_OK,"error":"","response":response}));
	},
	/**
	 * Set fail result
	 * @param primitive res
	...
	fail: function(error, code, response)
	{
		...
		var __v0 = use("Runtime.Message");
		return new __v0(use("Runtime.Dict").create({"code":code,"error":error,"response":response}));
	},

...
Runtime.Exceptions.KeyNotFound = function(key, context, prev)
{
	...
	use("Runtime.Exceptions.RuntimeException").call(this, "Key '" + use("Runtime.rtl").toString(key) + use("Runtime.rtl").toString("' not found"), __v0.ERROR_KEY_NOT_FOUND, context, prev);
};

...
Object.assign(Runtime.rs,
{
	...
	pathinfo: function(filepath)
	{
		...
		var arr1 = __v0.explode(".", filepath).toVector();
		var __v0 = use("Runtime.rs");
		var arr2 = __v0.explode("/", filepath).toVector();
		...
		var __v0 = use("Runtime.rs");
		ret.dirname = __v0.implode("/", arr2);
		var __v0 = use("Runtime.rs");
		var ext_length = __v0.strlen(ret.extension);
		if (ext_length > 0)
		{
			ext_length++;
		}
		var __v0 = use("Runtime.rs");
		ret.filename = __v0.substr(ret.basename, 0, -1 * ext_length);
		return ret;
	},
	/**
	...
	relativePath: function(filepath, basepath, ch)
	{
		...
		var __v0 = use("Runtime.rs");
		var base = __v0.explode(ch, basepath);

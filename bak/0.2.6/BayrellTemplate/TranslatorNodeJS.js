...
class TranslatorNodeJS extends TranslatorES6{
	...
	OpNamespace(op_code){
		...
		if (this.current_module_name != "BayrellRtl"){
			return "var rs = require('BayrellRtl').Lib.rs;"+rtl.toString(this.s("var rtl = require('BayrellRtl').Lib.rtl;"))+rtl.toString(this.s("var Vector = require('BayrellRtl').Types.Vector;"))+rtl.toString(this.s("var Map = require('BayrellRtl').Types.Map;"))+rtl.toString(this.s("var CoreView = require('BayrellWeb').CoreView;"))+rtl.toString(this.s("var CoreViewItem = require('BayrellWeb').CoreViewItem;"))+rtl.toString(this.s("var RenderContainer = require('BayrellWeb').RenderContainer;"));
		}
		return "";
	}
	/**

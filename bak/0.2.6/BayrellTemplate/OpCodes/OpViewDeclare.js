...
class OpViewDeclare extends BaseOpCode{
	...
	takeValue(variable_name, default_value){
		...
		if (variable_name == "view_name"){
			return this.view_name;
		}
		else if (variable_name == "view_extends"){
			return this.view_extends;
		}
		else if (variable_name == "view_variables"){
	...
	assignValue(variable_name, value){
		if (variable_name == "view_name"){
			...
			this.view_extends = value;
		}
		else if (variable_name == "view_variables"){
			this.view_variables = value;
		}
		else if (variable_name == "childs"){
			this.childs = value;
		}
